      ...
      <div className={styles.container}>
        ...
        <div className={styles.userDetail}>
          <div className={styles.avatarSection}>
            <img src={user.ava_img_path || avatar} alt="Avatar" className={styles.avatar} />
          </div>
          <div className={styles.infoSection}>
            ...
            <p>
              <strong>Phone:</strong> {user.phone_num || 'N/A'}
            </p>
            <p>
              <strong>Age:</strong> {user.age !== null ? user.age : 'N/A'}
            </p>
            <p>
              <strong>Status:</strong> {user.status}
            </p>

            <button className={styles.updateButton} onClick={handleUpdateStatus} disabled={isUpdating}>
              {isUpdating ? 'Updating...' : user.status === 'Active' ? 'Deactivate Account' : 'Activate Account'}
            </button>
          </div>
        </div>
      </div>
